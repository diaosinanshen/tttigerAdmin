...
//		}
     ...
     * @return
     */
    public static Date dateAdd(int addnum,Date date){
        Calendar now =Calendar.getInstance();
        now.setTime(date);
        now.set(Calendar.DATE,now.get(Calendar.DATE)+addnum);
        return  now.getTime();
    }
    /**
     * @title: dateCompare
    ...
    public static void main(String[] args) throws Exception{
        ...
        date=format.parse("2019-06-01");

        Date date1=dateAdd(-1,date);
